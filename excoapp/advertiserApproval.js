...
function makeCard(postId, ccName, ccNumber, cvc, email, firstName, lastName, companyName, phone1, phone2, productInfo, website) {
  htmlString = `<div class = "divBreak" id = ${postId} >
					<div class="card" style="width: 65rem; background-color: white; font-size: 35px; border-radius: 25px;
					border: 2px solid #73AD21;
					padding: 20px;
					" >
					<div class="card-body">
					<h5 class="card-title" style="font-weight: bold; font-size: 30px;">Credit Card Name: ${ccName}</h5>
